  ...
  <div class="contianer">
    <el-aside>
      <el-menu>
        ...
        <el-menu-item index="2" @click="setActive('2')">管理员信息</el-menu-item>
        <el-menu-item index="3" @click="setActive('3')">报修记录</el-menu-item>
        <el-menu-item index="5" @click="setActive('5')">额外功能</el-menu-item>
